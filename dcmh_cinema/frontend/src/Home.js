...
class Home extends React.Component {
    render() {
        return ( <
            ...
            <
            Link to = "/" > < i id = "nut-play"
            class = "fas fa-play" > < /i></Link >
            <
            /div> <
            /div>
            ...
            <
            Link to = "/" > < img style = {
                { height: "180px", width: "315px" } }
            src = "http://www.lottecinemavn.com/Media/Event/d92cc87a0dea428aaebfd37612fe7627.jpg" / > < /Link> <
            /div> <
            div className = "o-thu-tu" >
            <
            Link to = "/" > < img style = {
                { height: "285px", width: "315px" } }
            src = "http://www.lottecinemavn.com/Media/Event/f934ea227a014015af2e20d06ae916cd.jpg" / > < /Link> <
            /div> <
            /div> <
            /div>
            ...
            <
            Link to = "/" > < img style = {
                { height: "231px", width: "230px" } }
            src = "http://www.lottecinemavn.com/Media/Event/bbc58a0fd73547e0991820a443d48784.jpg" / > < /Link> <
            /div> <
            div className = "phai-hai" >
            <
            Link to = "/" > < img style = {
                { height: "460px", width: "230px" } }
            src = "http://www.lottecinemavn.com/Media/Event/3b39fb3f0b23422a89a172392714cb95.jpg" / > < /Link> <
            /div> <
            /div>
